...
\begin{enumerate}
  ...
  z~testem \SIrange{0.5}{1.0}{m}, choć jego dokładną wartość nadal ogranicza
  blokowa kolejność sesji.
  \item Do odpowiedzi na pytanie praktyczne nie była potrzebna mechaniczna
  szyna pozycjonująca. Statyw, dalmierz, kontrola poziomu i~zwrotu lasera
  wystarczyły do wykazania dużego efektu geometrii; w~ewentualnym dalszym
  teście folii ważniejsza byłaby randomizacja lub powtórzenie całych bloków
