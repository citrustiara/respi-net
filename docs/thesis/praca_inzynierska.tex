...
\SI{0.20}{Hz}; oddechy były pełne i~pogłębione. Powtarzaną serię
\SIrange{30}{100}{cm} rozdzielono od pojedynczego retestu \SI{150}{cm}.}
...
\begin{figure}[H]
    ...
    \caption[Estymacja rytmu HB100 dla 30--150 cm]{Estymacja rytmu HB100 we
    wszystkich 14 blokach. Krzyżyki oznaczają najsilniejszy pojedynczy pik
    widma, a~zielone punkty --- wynik konsensusu harmonicznych; każdy pomiar
    zawiera dwa bloki. W~powtarzanej serii \SIrange{30}{100}{cm} wszystkie
    12 estymat mieszczą się w~zakresie 11,9--12,2~oddechów/min wobec zadanych
    12~oddechów/min. Dwa punkty przy \SI{150}{cm} należą do pojedynczego
    retestu i~leżą blisko progu jakości $S_{\max}/\operatorname{med}S=2{,}0$;
    nie stanowią potwierdzenia użytecznej estymacji faz oddechu.}
...
zadanego rytmu. Pokazuje to użyteczność sumowania harmonicznych dla
powtarzalnego, silnego ruchu na krótkim dystansie. W~pojedynczym reteście
\SI{150}{cm} wynik \SI{0.190}{Hz} w~pierwszym bloku i~\SI{0.202}{Hz}
w~drugim znalazł się wprawdzie blisko wartości zadanej, lecz marże 2,9 i~2,1
były wielokrotnie mniejsze niż 5,7--21,5 w~serii krótkodystansowej. Rytm na
