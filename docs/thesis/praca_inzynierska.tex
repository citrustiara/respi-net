...
oddechu. Każdy wariant jest powtarzany dwukrotnie. Po uzyskaniu kompletnego
zapisu obu torów porównane będą:
...
\todo{Wykonać porównanie LSM6DS3 i~iPhone wyłącznie w~dwóch 90-sekundowych
próbach programu prowadzącego: \SI{10}{s} oddechu swobodnego, 7~cykli wdech
\SI{2}{s}/wydech \SI{3}{s}, \SI{15}{s} wstrzymania oraz 6~dalszych cykli.
Telefon ma pracować z~\SI{100}{Hz}, odblokowany i~z~aplikacją na pierwszym
planie. Po pozytywnej kontroli transmisji BLE porównać pokrycie czasowe, luki,
$f_R$, SNR, stabilność okien i~przebieg PCA obu urządzeń.}
