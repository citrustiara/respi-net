...
oddechu i~jego zatrzymanie do \SI{100}{cm}, lecz jego jednokanałowy przebieg
nie zachowywał stabilnie kierunku wdech--wydech; A121 umożliwiał taką analizę
na podstawie fazy I/Q. Przeprowadzono również
...
\todo{Dodać zrzut ekranu aplikacji iOS: wybór częstości próbkowania i~stan
transmisji BLE.}
...
\todo{Dodać zrzuty ekranu aplikacji desktopowej: widok A121 na żywo i~widok
historii nagrań.}
...
\todo{Dodać zrzut ekranu programowego przewodnika oddechu podczas nagrania.}
...
Sekwencję oddechową prowadził programowy przewodnik opisany w~sekcji
\ref{sec:breathing-coach}. Po \SI{10}{s} oddechu swobodnego następowało
...
HB100 nie zachował jednak rytmu ani kierunku fazy: w~dwóch blokach dominowały
...
wdech--wydech 36,6\%. W~tym samym nagraniu A121 z~płaską pokrywą osiągnął
$r=0{,}910$ i~96,7\% zgodności kierunku. Wynik wskazuje więc praktyczną
granicę użycia HB100 do rozróżniania faz w~tej geometrii, przy równoczesnym
zachowaniu przewagi koherentnego A121. Jest to jednak tylko jeden retest;
nie wyznacza ogólnego zasięgu żadnego z~radarów, a~zwłaszcza A121 z~soczewką
skupiającą.
...
HB100 wiarygodnie realizował pierwszy z~nich. Częstość można wyznaczać tylko
warunkowo, uwzględniając kandydatów $f$, $f/2$ i~$f/3$; kierunku wdech--wydech
nie udało się zachować po jednorazowej kalibracji znaku.
...
który udostępnia bramki odległościowe i~zespolony sygnał I/Q.
...
\begin{itemize}
  ...
  Sparse~IQ.
  \item W~równoczesnych nagraniach HB100 wykrywał sterowany oddech i~jego
  zatrzymanie do \SI{100}{cm}; podczas wstrzymania RMS malał o~
  ...
  wdech--wydech. A121 osiągał w~tym samym teście 95,9--99,3\% opisowej
  zgodności kierunku, dlatego to jego faza I/Q jest właściwym wejściem do
  analizy faz cyklu. Pojedynczy retest \SI{150}{cm} podtrzymał ten wniosek:
  HB100 wykazał zanik przy wstrzymaniu, lecz nie kierunek fazy, podczas gdy
  A121 z~płaską pokrywą zachował 96,7\% zgodności kierunku.
