...
Acconeer,
\emph{Lens design}, A121 integration documentation, accessed from local copy \texttt{data/Lens design --- Acconeer docs.htm}. Key points used here: dielectric lenses shape the beam and increase gain; plano-convex and FZP example lenses are provided; focal distance may need tuning because housing/radome effects can shift the gain maximum.
\end{thebibliography}
