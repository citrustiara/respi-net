...
\begin{frame}{Cel i zakres pracy}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item Przetestowanie precyzyjnego radaru Acconeer A121.
        \end{itemize}
...
\begin{frame}{Stanowisko pomiarowe -- IMU}
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth,keepaspectratio]{plots_imu/imu_.png}
...
\begin{frame}{Aktualny stan pracy -- Radar Dopplerowski (HB100)}
    \begin{itemize}
        ...
        \begin{itemize}
            \item Wyraźny sygnał oddechu z odległości ok. 50 cm od klatki piersiowej.
            \item Wstrzymanie oddechu odsłania oscylacje odpowiadające pracy serca (tętno jest detekowalne).
        \end{itemize}
        \item \textbf{Oprogramowanie:} Stworzono moduł w Pythonie (\texttt{radar\_viewer.py}) z odczytem 250 Hz (230400 baud) z ESP32 do analizy i rysowania wykresów FFT na żywo.
    \end{itemize}
\end{frame}
